        ...
        layout_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(editAge.length() == 0 || editWeight.length() == 0 || editHeight.length() == 0){
                    ...
                    if(!isInteger(editAge.getText().toString()) || !isDouble(editHeight.getText().toString()) || !isDouble(editWeight.getText().toString())){
                        Toast.makeText(getApplicationContext(), "Use numeric format to fill the data", Toast.LENGTH_SHORT).show();
                    }else {
...
//                        userParameters = new UserParameters(selectedGender, selectedGoal, selectedActivity, height, weight, age);
//
//                        mDataBase.push().setValue(userParameters);

                        System.out.println("################ Info: \n" + age + "\n" + "\n" + weight + "\n" + selectedActivity);
                        startActivity(new Intent(ParametersActivity.this, UserInfoRegActivity.class));
                    }
                }
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ParametersActivity.this, HomeActivity.class));
                //System.out.println(calculateBMR(192, 62, 22));
            }
        });
    }

    private void updateParams(String gender, String activity, String goal, double height, double weight, int age) {
